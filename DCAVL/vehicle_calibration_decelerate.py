...
def main():
    try:
        ...
        for brake in np.arange(0,0.6,0.01):
            ...
            while True:
                ...
                if vehicle_speed <= 120 and accelerate:
                ...
                if time_step >= 2:
                    ...
                    model_list.append([vehicle_speed/3.6, current_acc, 0, brake])
                ...
                if vehicle_speed > 130:
                    print('speed reaches 130km/h, now exit')
                    vehicle_register.destroy_int_vehicles([int_vehicle])
                    break
                ...
                world.tick()
                if time_step < 1 or not accelerate:
                    time_step += 1
        ...
        model_list_pd.to_csv(data_path + '\\model_calibration_dataset_brake.csv', index=False)
